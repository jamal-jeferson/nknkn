...
import allProducts, { getAllCategories } from '../data/productsData';
    ...
    <>
      ...
      <section className="pt-32 pb-16 bg-rb-black texture-overlay relative">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bebas mb-6">All Products</h1>
            <p className="text-lg text-rb-gray-300">
              Browse our complete range of custom sportswear and apparel
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {/* Products Grid */}
      <section id="products-list" className="py-16 bg-rb-gray-900 scroll-mt-32">
        <div className="container-custom">
      ...
      <section className="py-20 bg-rb-black">
        <div className="container-custom text-center">
          ...
          >
            <h2 className="text-4xl font-bebas mb-6">Ready to Order Your Custom Kit?</h2>
